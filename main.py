...
def main():
    ...
    while True:
        ...
        position = ((position[0] + (speed//15) + 1) % width_screen, position[1])
        if position[0] + width_character > width_screen:
            screen.blit(img_characters[image_index], (position[0] - width_screen, position[1]))
